#!/bin/busybox ash
#
# Modified for the Chromebit project (2026).
# Derived from postmarketOS "postmarketos-initramfs" (GPL-2.0-or-later).
# See README.md and COPYING in this directory for provenance and licence.
